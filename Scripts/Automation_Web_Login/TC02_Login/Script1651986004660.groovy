...
WebUI.setText(findTestObject('Object-Web/Object_Login/txt_email'), 'hans@email.com')

WebUI.setText(findTestObject('Object-Web/Object_Login/txt_password'), '123123bandung')
